...
import photo from "./images/fotoğrafs.jpg"

export default function Profile() {
  return (
    <div className="p-24 md:mt-40" id='profile'>
    <div className="text-center mb-4 opacity-90">
        <a href="index" className="block relative">
            <img alt="profil" src={photo} className="mx-auto object-cover rounded-full h-40 w-40 "/>
        </a>
    </div>
    <div className="text-center">
        ...
        <p className="text-md text-gray-500 dark:text-gray-200 font-light py-4 font-light max-w-sm mx-auto">
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Mollitia, soluta assumenda! Incidunt iusto dolorum dicta.
        </p>
